...
The span of a set of vectors $\mathcal{B} = \left{v_1, \ldots, v_k\right}$ is the set of all linear combinations of the vectors in the set. That is, $\text{span }\mathcal{B} = \{c_1v_1 + \cdots + c_kv_k : c_i \in \mathbb{F}\}$.
